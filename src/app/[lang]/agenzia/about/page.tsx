            ...
            <section className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
                    <div className="animate-reveal">
                        <span className="text-skyblue font-bold uppercase tracking-widest text-xs mb-4 block italic">
                            {t.hero.badge}
                        </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 animate-reveal">
                    <div className="p-12 bg-gray-50 rounded-[3rem] border border-gray-100">
                        <h3 className="text-2xl font-bold mb-6 italic text-navy">{t.sections.experience.title}</h3>
                        <p className="text-gray-500 font-light leading-relaxed">{t.sections.experience.text}</p>
                    </div>
                    <div className="p-12 bg-skyblue rounded-[3rem] text-white">
                        <h3 className="text-2xl font-bold mb-6 italic">{t.sections.community.title}</h3>
                        <p className="text-white/80 font-light leading-relaxed">{t.sections.community.text}</p>
                    </div>
                </div>
            </section>
        </main>
