...
export default function AgenziaContact() {
        ...
        <main className="pt-40 pb-32">
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20">
                <div className="animate-reveal">
                    <h1 className="text-5xl font-black mb-10 italic text-navy leading-tight" dangerouslySetInnerHTML={{ __html: t.hero.title }}></h1>
                    <div className="mb-12">
                        <h3 className="text-xl font-bold mb-4 italic text-skyblue">{t.info.office.title}</h3>
                        <p className="text-gray-500 font-light text-lg whitespace-pre-line">
                            {t.info.office.address}
                        </p>
                    </div>
                    <div className="mb-12">
                        <h3 className="text-xl font-bold mb-4 italic text-skyblue">{t.info.contacts.title}</h3>
                        <p className="text-gray-500 font-light text-lg">
                            {t.info.contacts.phone}<br />
                            {t.info.contacts.mobile}
                        </p>
                    </div>
                </div>
                <div className="animate-reveal">
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="relative">
                                <select className="contact-input appearance-none w-full">
                                    <option>{t.form.service_placeholder}</option>
                                    {t.form.services.map((service: string, idx: number) => (
